// Handles the loading in of weather images
...
bool isRain(environment *env) { return env->data.waterLevel > WET_TRESH; }

// Returns whether temperature is greater than the threshold for hotness
bool isHot(environment *env) { return env->data.tempC > HOT_TRESH; }
