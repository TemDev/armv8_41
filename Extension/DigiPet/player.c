// File that is responsible for the player, updates its position and health as well as generates it
#include "fruits.h"
#include "player.h"
#include "weather.h"
#include <stdlib.h>
...
// Retruns the walking texture corresponding to the index
...
// Updates the velocity of the player in the environment
